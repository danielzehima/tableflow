...
export default function Sidebar({ isOpen = false, onClose, restaurantName, restaurantSlug, userName, userRole, initials }: SidebarProps) {
  ...
  const navItems = [
    { href: "/dashboard", icon: HomeIcon, label: "Vue d'ensemble", always: true },
    ...
    { href: "/dashboard/personnalisation", icon: PaletteIcon, label: "Personnalisation", always: true },
    { href: "/dashboard/avis", icon: StarIcon, label: "Avis clients", always: true },
    ...
    { href: "/dashboard/parametres", icon: SettingsIcon, label: "Paramètres", show: canManageMenu(userRole) },
...
function ChefIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM7.5 6.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM16.5 6.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM5 9h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2a1 1 0 011-1zM7 13v7m5-7v7m5-7v7" />
    </svg>
  );
}
