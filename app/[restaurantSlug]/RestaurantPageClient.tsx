            ...
            <div className="py-6">
              ...
              {orderId && !isDemo && (
                <button
                  ...
                  className="w-full mb-4 bg-green-600 hover:bg-green-700 disabled:opacity-60 text-white font-bold py-3.5 rounded-xl text-sm transition-colors flex items-center justify-center gap-2"
                >
                  {payingOrder ? (
                    <><span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> {t.payRedirecting}</>
                  ) : (
                    <>💳 {t.payNow}</>
                  )}
                </button>
